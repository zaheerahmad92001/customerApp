...
const ResolvedRequestCard = (Item) => {
    return (
        <View style={styles.card}>
            ...
            <View style={styles.columnView}>
                <View style={styles.columnOneView}>
                    ...
                    <Text style={styles.value}>04 Feb 2025</Text>
                </View>

                <View style={styles.columnOneView}>
                    <Text style={styles.label}>Time</Text>
                    <Text style={styles.value}>03:00 Pm</Text>
                </View>
            ...
            <View style={styles.columnView}>
                ...
                <View style={styles.columnOneView}>
                    ...
                    <Text style={styles.value}>Sar 200</Text>
                </View>
            </View>
...
export default ResolvedRequestCard;